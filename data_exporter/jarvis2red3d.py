...
parser.add_argument('-s', '--skeleton', type=str, default='rat20')
...
for camera_id in range(len(cam_names)):
    ...
    with open(output_file, 'w', newline='') as f:
        ...
        keypoint_writer.writerow(["Rat20"])
...
# save 3d keypoints
output_folder_name = os.path.join(output_folder, 'worldKeyPoints')
os.makedirs(output_folder_name, exist_ok=True)
output_file_name = "{}_{}.csv".format("keypoints", dt_string)
output_file = os.path.join(output_folder_name, output_file_name)
print(output_file)
with open(output_file, 'w', newline='') as f:
    keypoint_writer = csv.writer(f, delimiter=',')
