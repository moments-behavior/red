#pragma once
// mujoco_opengl_renderer.h — Offscreen OpenGL rendering of MuJoCo body models
//
// Windows/Linux equivalent of mujoco_metal_renderer.h.
// Uses mjv_updateScene() to extract abstract geometry, then renders
// capsules/spheres/boxes with OpenGL shaders into an offscreen FBO
// that can be displayed via ImGui::Image().
...
// Opaque handle — implementation in .cpp file
...
// Must be an OpenGL texture ID (GLuint cast to void*).
