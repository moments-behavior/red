...
void decoder_process(const char *input_file_name, DecoderContext *dc_context, FFmpegDemuxer* demuxer, PictureBuffer *display_buffer, int size_of_buffer, SeekInfo *seek_context, bool use_cpu_buffer);
