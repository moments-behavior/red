...
Currently we are saving labeled keypoints simply as a plain csv file. We provide python scripts for formating data as [COCO format](https://docs.aws.amazon.com/rekognition/latest/customlabels-dg/md-coco-overview.html), which is used by [Jarvis](https://github.com/JARVIS-MoCap/JARVIS-HybridNet). Please refer to [utils](https://github.com/JohnsonLabJanelia/red/tree/main/utils).
