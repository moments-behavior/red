...
This is the Homebrew tap for [RED](https://github.com/moments-behavior/red),
...
```bash
brew uninstall red
brew untap moments-behavior/red
```
...
```bash
brew install --HEAD --verbose moments-behavior/red/red
```
and open an issue at https://github.com/moments-behavior/red/issues with
the output.
